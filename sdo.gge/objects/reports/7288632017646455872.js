// 7288632017646455872 - Отчет по заявкам ЭБ строим вместе РАБОТНИКИ

logger = {
    isLog: false,
    logType: "report",
    logName: "7288632017646455872",
}
...
var cond = " and doc-contains($elem/id, DefaultDb, '[fld_status=Работник организации]') "
...
addColumns(customTemplates, "stage3");
addColumns(customTemplates, "stage4");
addColumns(customTemplates, "stage5");
addColumns(customTemplates, "stage6");
