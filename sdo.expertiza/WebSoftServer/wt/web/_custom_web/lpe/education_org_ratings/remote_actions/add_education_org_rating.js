// 7451567539250776879 - add_education_org_rating - _custom_web/lpe/education_org_ratings/remote_actions/add_education_org_rating.js
...
function getCustomFormFields(teDoc) {
    ...
    sheetFields = customTemplates.fields
...
function doSave(aFields, teDoc) {
    var docTask;
    if (teDoc == undefined) {
        var arr = XQuery("for $elem in object_datas where object_data_type_id = 7441577045918571630 return $elem");
        var maxCode = 0;
        if (ArrayCount(arr)) {
        ...
        docTask.TopElem.object_data_type_id = 7441577045918571630 // Рейтинг обучающей организации
    ...
    case "submit_form":
        ...
        switch (nextCommand) {
            case "first_form":
                ...
                l.write(logger, "sAction=" + sAction)
                switch (sAction) {
                    ...
                    case "Добавить":
                        ...
                        // ]
                        var arr = [];
                        oForm.form_fields = ArrayUnion(arr, getCustomFormFields());
                    ...
                    case "Редактировать":
                        ...
                        //         }
                        //     ]
                        //     arr1 = getCustomFormFields(curObject);
                        // }
                        
                        // if (OptInt(curObject.sec_object_id) == OptInt(curUserID)) {
                        //     arr2 = getCustomFormFields(curObject);
                        // }

                        // oForm.form_fields = ArrayUnion(arr, arr1, arr2);
                        oForm.form_fields = getCustomFormFields(curObject);
