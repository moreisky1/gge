<%
// 133 - Назначение теста сотруднику (уведомление руководителя)
...
if (isInGroup(tools.get_uni_user_boss(objDoc.person_id).id, 7261897522649114757)) {
    ...
    TEXT = "Сотруднику " + objDoc.person_id.ForeignElem.fullname + " назначен тест " + objDoc.course_id.ForeignElem.title + ".";
}
%>
<%=TEXT%>